...
export const infoCards = [
  { title: 'Calculator',  text: 'What is 5 plus/+ 10' },
  { title: 'Calculator', text: 'Calculate 10 by/* 2' },
  { title: 'Calculator', text: 'Compute square root of 25' },
  { title: 'Calculator',text: 'Calculate 50 squared' },
];
